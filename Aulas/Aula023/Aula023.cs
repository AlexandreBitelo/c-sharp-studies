...
class Aula023
{
    static void Main ()
    {
        ...
        // public static void Copy (Ar_origem, Ar_destilo, qtde_elementos);
        ...
        // public void CopyTo (Ar_destino, a_partir_desta_posição);
